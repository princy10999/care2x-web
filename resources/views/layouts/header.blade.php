...
<head>
    ...
    <title>Care2X Admin</title>
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset('assets/css/feather/feather.css') }}">
    <link rel="stylesheet" href="/all_css/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="/all_css/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="/all_css/datatables.net-bs4/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="/all_css/ti-icons/css/themify-icons.css">
